                                ...
                                <div className="container">
                                    ...
                                    <div className="form wow fadeInUp" data-wow-delay="0.3s">
                                        <form className="subscribe-form wow zoomIn">
                                            <input className="mail" type="email" name="email" placeholder="Email address" />
                                ...
                                <div className="container">
                                    <div className="col-md-12 text-center">
                                        ...
                                        <ul className="footer-menu">
                                            <li><a href={DEMO.BLANK_LINK}>Site</a></li>
                                            <li><a href={DEMO.BLANK_LINK}>Support</a></li>
                                            <li><a href={DEMO.BLANK_LINK}>Terms</a></li>
                                            <li><a href={DEMO.BLANK_LINK}>Privacy</a></li>
                                        </ul>
